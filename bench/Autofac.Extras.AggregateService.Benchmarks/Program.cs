...
internal static class Program
{
    internal static void Main(string[] args)
    {
        ...
        // dotnet run -c Release --project bench/Autofac.Extras.AggregateService.Benchmarks -- --filter *Benchmark*
        //
        // Run the benchmark comparing the source code version to a specific package version:
        // dotnet run -c Release --project bench/Autofac.Extras.AggregateService.Benchmarks -- --baseline-version 7.0.0 --filter *Benchmark*
        //
